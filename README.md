...
Before using **Alayers Tools**, make sure you have installed a few required tools:
...
## **Installing Alayers Tools**

To install **Alayers Tools** on your system, follow these steps:

### **1. Clone the Repository**

Clone the **Alayers Tools** repository using `git`:
...
## **How to Run Alayers Tools**

Once the installation is complete, you can run **Alayers Tools** as follows:

### **1. Running the Tools**

To run **Alayers Tools**, simply execute the Python file `alayers.py` in the directory where you cloned the repository. You can run it using the following command:
...
## **Running Alayers Tools Anywhere (Linux)**

To run **Alayers Tools** from anywhere on Linux, you need to add the tool’s path to your **PATH environment variable**.

### **Steps:**

1. **Clone the Repository to the Desired Directory**

   Clone the **Alayers Tools** repository into the desired directory:
...
2. **Add the Path to the `PATH` Variable**
   ...
   Add the directory where **Alayers Tools** is located to your `PATH` environment variable. This can be done by adding the following line to your shell configuration file (`~/.bashrc` or `~/.zshrc`, depending on the shell you use):

   ```bash
   export PATH="$PATH:/path/to/alayers-dir"
   ```

   Replace `/path/to/alayers-dir` with the actual path where **Alayers Tools** is located.
...
4. **Run the Tools from Anywhere**
   ...
   Now, you can run **Alayers Tools** from any terminal by simply typing:
...
Sebelum menjalankan **Alayers Tools**, pastikan Anda telah menginstal beberapa alat yang dibutuhkan:
...
## **Instalasi Alayers Tools**

Untuk menginstal **Alayers Tools** di sistem Anda, ikuti langkah-langkah berikut:

### **1. Clone Repository**

Clone repository **Alayers Tools** menggunakan `git`:
...
## **Cara Menjalankan Alayers Tools**

Setelah instalasi selesai, Anda dapat menjalankan **Alayers Tools** dengan cara berikut:

### **1. Menjalankan Tools**

Untuk menjalankan **Alayers Tools**, cukup jalankan file Python `alayers.py` di direktori tempat Anda meng-clone repository. Anda bisa menjalankannya menggunakan perintah:
...
## **Menjalankan Alayers Tools di Mana Saja (Linux)**

Agar **Alayers Tools** bisa dijalankan dari mana saja di terminal Linux, Anda perlu menambahkan path ke skrip ke dalam **PATH environment variable**.

### **Langkah-langkah:**

1. **Clone Repository ke Direktori yang Diinginkan**

   Clone repository **Alayers Tools** ke dalam direktori yang Anda inginkan:
...
2. **Tambahkan Path ke dalam `PATH`**
   ...
   Tambahkan direktori tempat **Alayers Tools** berada ke dalam environment `PATH` Anda. Ini bisa dilakukan dengan menambahkan baris berikut ke dalam file `~/.bashrc` atau `~/.zshrc` (tergantung shell yang Anda gunakan):

   ```bash
   export PATH="$PATH:/path/to/alayers-dir"
   ```

   Gantilah `/path/to/alayers-dir` dengan path yang sesuai dengan lokasi direktori **Alayers Tools** Anda.
...
4. **Menjalankan Tools dari Mana Saja**
   ...
   Sekarang Anda dapat menjalankan **Alayers Tools** dari terminal mana saja dengan cukup mengetikkan:
